...
export default function GenericProject(props: GenericProjectProps) {
    ...
    const projectInfoWrapper = `w-100 f-row j-between a-center px-3 `
    return (
        <>
            {/* Container */}
            <div id={props.id} className={genericProjectWrapper}>

                <img id={props.id + props.title + 'image'} src={props.image} alt={props.title} className={styles.projectImage} style={{ width: '580px' }} />
